...
exports.login = async (req, res) => {
    try {
        ...
        // Kiểm tra admin trước (role = 1)
        const [adminRows] = await UserModel.findAdminByEmailAndPassword(email, password);
...
exports.register = async (req, res) => {
    try {
        ...
        const [result] = await UserModel.create({ name, email, password, phone, address });
