...
import { FacebookOutlined, InstagramOutlined, YoutubeOutlined, TwitterOutlined, EnvironmentOutlined, PhoneOutlined, MailOutlined, ClockCircleOutlined, RightOutlined } from '@ant-design/icons';
import './Footer.css';
        ...
        <footer className="footer-wrap">
            <div className="footer-inner">
                <div className="footer-grid">
                    ...
                    <div className="footer-brand-col">
                        <div className="footer-brand-header">
                            ...
                            <div className="brand-name">XDPTPM Shop</div>
                        </div>
                        ...
                        <div className="footer-social">
                            {[FacebookOutlined, InstagramOutlined, YoutubeOutlined, TwitterOutlined].map((Icon, i) => (
                    ...
                    <div>
                        ...
                        <div className="footer-newsletter-wrap">
                            <div className="footer-col-title footer-newsletter-title">ĐĂNG KÝ NHẬN ƯU ĐÃI</div>
                ...
                <div className="footer-bottom">
                    <span className="footer-bottom-text">© 2024 XDPTPM Shop. All rights reserved.</span>
