    ...
    const handleInventoryChange = ({ variantId, newStock }) => {
      setProduct(prev => {
        ...
        const updatedVariants = prev.variants.map(v =>
          v.variant_id === variantId ? { ...v, variant_quantity: newStock } : v,
        );
  ...
  if (!product)
    return (
      <div className="detail-empty-center">
        <Title level={3} className="detail-empty-title">
      ...
      children: (
        <div className="detail-specs-grid">
          {[
            ...
            {
              label: "Tình trạng",
              value: stockQuantity > 0 ? "Còn hàng" : "Hết hàng",
            },
          ].map((item, i) => (
            <div key={i} className="detail-spec-item">
              <div className="detail-spec-label">
      ...
      <div className="page-breadcrumb">
        <Breadcrumb
          items={[
            ...
            {
              title: (
                <span className="detail-breadcrumb-last">
          ...
          <Row gutter={[48, 32]}>
            ...
            <Col xs={24} md={10}>
              <div className="detail-gallery">
                ...
                >
                  {hasDiscount && (
                    <div className="product-badge detail-badge-pos">
                      -{discountPercent}%
                    </div>
                  )}
            ...
            <Col xs={24} md={14}>
              ...
              <Title level={2} className="detail-title-text">
                {product.product_name}
              </Title>
              ...
              <Space wrap className="detail-guarantees">
                ...
                <Tag icon={<UndoOutlined />} color="blue">
                  Đổi trả 7 ngày
                </Tag>
              ...
              <div className="detail-qty-section">
                <Text strong className="detail-qty-label">
                  Số lượng:
                </Text>
                <InputNumber
                  min={1}
              ...
              <div className="detail-meta">
                ...
                <div className="detail-meta-item">
                  ...
                  <span>Giao hàng nhanh tại TP.Hà Nội</span>
                </div>
              </div>
            </Col>
          </Row>
